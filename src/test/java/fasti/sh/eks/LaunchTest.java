...
public class LaunchTest {
  ...
  @Test
  public void testArnToBucketNameWithDoubleLeadingSlash() {
    String arn = "arn:aws:s3::://bucket";
    String result = Launch.arnToBucketName(arn);
    assertEquals("", result);
  }
  ...
  @Test
  public void testArnToBucketNameWithSpecialS3Characters() {
    String arn = "arn:aws:s3:::bucket-with_underscore.and.dots-123";
    String result = Launch.arnToBucketName(arn);
    assertEquals("bucket-with_underscore.and.dots-123", result);
  }

  @Test
  public void testArnToBucketNameWithQueryParameters() {
    String arn = "arn:aws:s3:::bucket/path?versionId=123";
    String result = Launch.arnToBucketName(arn);
    assertEquals("bucket", result);
  }

  @Test
  public void testArnToBucketNameWithFragments() {
    String arn = "arn:aws:s3:::bucket-name/path#fragment";
    String result = Launch.arnToBucketName(arn);
    assertEquals("bucket-name", result);
  }

  @Test
  public void testArnToBucketNameWithEncodedCharacters() {
    String arn = "arn:aws:s3:::bucket-name/path%20with%20spaces";
    String result = Launch.arnToBucketName(arn);
    assertEquals("bucket-name", result);
  }
}
